...
//////////////////////////////////////////////////////////////////////////////////////////////
        ...
        { Win,                  XK_z,           killclient,       {0} },
        { Win,                  XK_Left,        focusmon,         {.i = -1 } },
        { Win,                  XK_Right,       focusmon,         {.i = +1 } },
        { Win,                  XK_d,           spawn,            {.v = rofi_launcher_cmd } },
	{ Win,                  XK_F1,          spawn,            SHCMD("brightnessctl set 2%-") },
	{ Win,                  XK_F2,          spawn,            SHCMD("brightnessctl set +2%") },
	{ Win,                  XK_F9,          spawn,            SHCMD("pactl set-sink-volume 0 +2%") },
	{ Win,                  XK_F8,          spawn,            SHCMD("pactl set-sink-volume 0 -2%") },
	{ Win,                  XK_F10,         spawn,            SHCMD("pactl set-sink-mute 0 toggle") },
